...
ax3.scatter(np.arange(len(nc_evolv_all_bp_rules)), [np.mean(e) for e in nc_evolv_all_bp_rules])
ax4.scatter(np.arange(len(nc_evolv_allowed_bp_rules)), [np.mean(e) for e in nc_evolv_allowed_bp_rules])

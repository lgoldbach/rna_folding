...
if __name__ ==  "__main__":
    ...
    phenotypes = list(set(nx.get_node_attributes(G, "phenotype").values()))
    ...
    for target_ph in phenotypes:  # loop over target phenotypes
        ...
        for i in range(args.sample_size_landscapes):
            ...
            for ph in phenotypes:
                ph_to_fitness[ph] = np.random.uniform()  # in [0, 1) interval
            ...
            start_gt = np.random.choice(G.nodes, size=args.sample_size_walks)

...
if __name__ ==  "__main__":
    ...
    for i, fl in enumerate(args.fitness_landscapes):
        ...
        axes[i][1].scatter(np.log10(nc_size_peak), per_nc_navigability_peak, color="red", alpha=0.5, label="local peak")
        axes[i][2].scatter(nc_f_peak, per_nc_navigability_peak, color="red", alpha=0.5, label="local peak")

        axes[i][0].scatter(per_nc_accessibility_plat, per_nc_navigability_plat, color="green", alpha=0.5, label="plateau")
        axes[i][1].scatter(np.log10(nc_size_plat), per_nc_navigability_plat, color="green", alpha=0.5, label="plateau")
        axes[i][2].scatter(nc_f_plat, per_nc_navigability_plat, color="green", alpha=0.5, label="plateau")
        # for global
        axes[i][0].scatter(accesibility_global_peak, navigability_global_peak, marker="*", s=50, color="yellow", label="global peak")
        axes[i][1].scatter(np.log10(peak_size_global), navigability_global_peak, marker="*", s=50, color="yellow", label="global peak")
        axes[i][2].scatter(peak_f_global, navigability_global_peak, marker="*", s=50, color="yellow", label="global peak")

        axes[i][3].plot(range(len(plateau_steps)), plateau_steps, color="green", label="plateau")
        ...
        axes[i][1].set_xlabel("Peak size") 
        axes[i][2].set_xlabel("Peak fitness")

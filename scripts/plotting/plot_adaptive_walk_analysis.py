...
if __name__ ==  "__main__":
    ...
    parser.add_argument("-p", "--nc_paths", help="File with adaptive walks along neutral components", nargs="+", required=True)
    ...
    parser.add_argument("-l", "--walk_length", help="Max. length of adaptive walks", type=int, required=True)
